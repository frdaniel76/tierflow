 ...
 * Requires real API keys and a running FreeRouter instance.
 *
 * Usage:
 *   npm run demo:generate
 *
 * This script:
 * 1. Sends each prompt through FreeRouter to get routing decisions
...
console.log(`
  ...
  It requires:
    - A running FreeRouter instance at :18800
  ...
  To implement live generation:
    ...
    2. For each prompt, call FreeRouter /v1/chat/completions
